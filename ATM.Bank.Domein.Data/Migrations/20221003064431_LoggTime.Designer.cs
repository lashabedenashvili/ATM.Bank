...
namespace ATM.Bank.Domein.Data.Migrations
{
    ...
    [Migration("20221003064431_LoggTime")]
    partial class LoggTime
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ATM.Bank.Domein.Data.Data.BlockCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ATM.Bank.Domein.Data.Data.LoggTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ATM.Bank.Domein.Data.Data.BlockCard", b =>
                {
                    b.HasOne("ATM.Bank.Domein.Data.Data.Card", null)
                        .WithMany("BlockCard")
                        .HasForeignKey("CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ATM.Bank.Domein.Data.Data.Card", b =>
                {
                    ...
                    b.Navigation("BlockCard");

                    b.Navigation("LoggTime");
                });
